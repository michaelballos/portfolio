...
export default function SkillsetText() {
  ...
  return (
    <div className={classes.skillsContainer}>
      ...
      <Text className={classes.skillsDescription}>
        Docker, Postman, Rest, Node, Express, Jest, ESLint, Lerna, Prisma, Git,
        Photoshop, Figma, Axios, Swagger, Prettier Prisma,
        Mantine, Three/Fiber, Three/Drei, Auth0, Passport JS, Bootstrap,
